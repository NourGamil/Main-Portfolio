...
export default function Footer() {
  ...
  return (
    <section 
      id="contact" 
      className="snapper content-section relative w-full h-[100dvh] mt-[-1px] sm:pt-[50px] lg:pt-[30vh] bg-black/90 backdrop-blur-sm flex flex-col justify-between pt-24 pb-10 px-6 md:px-24 overflow-hidden text-[var(--tx1-1)]"
    >
