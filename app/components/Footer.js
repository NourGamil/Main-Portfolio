...
export default function Footer() {
  ...
  return (
    <section 
      id="contact" 
      className="snapper relative w-full h-[100dvh] mt-[-1px] md:pt-[22vh] lg:pt-[30vh] bg-black/90 backdrop-blur-sm flex flex-col justify-between pt-24 pb-10 px-6 md:px-24 overflow-hidden text-[var(--tx1-1)]"
    >
      {/* Glossy Effect */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full pointer-events-none" />
      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-20">
        ...
        {/* LEFT: Catchy Words & Direct Mail */}
        <div>
          <div className="line-mask mb-6 md:mb-12">
            <h2 className="reveal-line text-[var(--tx2)] italic uppercase tracking-[0.4em] font-bold text-[10px] md:text-sm">
              05. Contact me
            </h2>
          </div>
          <h2 className="text-5xl md:text-8xl font-black uppercase tracking-tighter leading-[0.9] md:leading-none">
            Let's <span className="text-[var(--tx3)]">talk.</span>
          </h2>
          <p className="mt-4 md:mt-6 text-gray-400 font-mono text-[10px] md:text-sm tracking-widest uppercase">
            Available for new masterpieces. Based in Egypt.
          </p>
          ...
          <form 
            ...
            method="post" 
            encType="text/plain"
            className="mt-8 md:mt-12 flex flex-col gap-4 max-w-md"
          >
            <div className="relative group">
              <input 
                type="text" 
        ...
        <div className="grid grid-cols-2 md:grid-cols-2 gap-6 md:gap-10">
          ...
          <div className="flex flex-col gap-2 md:gap-4">
            <h4 className="text-[#fdc700] font-bold text-[9px] md:text-[10px] uppercase tracking-[0.4em] mb-2">Digital Footprint</h4>
            <SocialLink href="https://www.linkedin.com/in/nour-gamil-5901a7286/" label="LinkedIn" />
            <SocialLink href="https://github.com/NourGamil" label="GitHub" />
            <SocialLink href="https://wa.me/201221646925" label="WhatsApp" />
            <SocialLink href="https://www.instagram.com/nourgamil12/" label="Instagram" />
      ...
      {/* Bottom Bar */}
      <div className="mt-8 pt-6 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4 text-[8px] md:text-[10px] font-mono text-[var(--tx1-1)] tracking-widest uppercase text-center md:text-left">
        <p>© 2026 NOUR GAMIL. ALL RIGHTS RESERVED.</p>
...
function SocialLink({ href, label }) {
  return (
    <a 
      href={href} 
      target="_blank" 
      className="group flex items-center justify-between border-b border-white/5 py-1 md:py-2 hover:border-[#fdc700] transition-colors"
    >
